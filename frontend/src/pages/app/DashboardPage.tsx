      ...
      <div className="p-6 space-y-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
            <DashboardCard
              ...
              progress={summary.spendingIsUp ? 80 : 50} // Example logic — refine as needed
            />
            <DashboardCard
            ...
            <DashboardCard
              ...
              progress={
                summary.activeBudgets > 0 && summary.budgetAllocatedTotal > 0
            ...
            <DashboardCard
              ...
              progress={summary.totalSavings > 0 ? 75 : 0} // Placeholder, adjust as needed
        ...
        {/* Could go below Insights + RecentActivity */}
        <div className="grid md:grid-cols-2 gap-4 mt-6">
