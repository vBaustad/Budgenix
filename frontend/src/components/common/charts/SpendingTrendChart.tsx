  ...
  return (
    <>
      ...
      <div className="flex justify-between text-sm font-medium tracking-wide tabular-nums px-1 mb-1">
        <span className="text-success">Min: {formatCurrency(min, currency)}</span>
        <span className="text-error">Max: {formatCurrency(max, currency)}</span>
      </div>
      ...
      <div className="h-64 w-full">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip content={<CustomTooltip currency={currency || 'USD'} />} />
            <Line
              type="monotone"
              dataKey="value"
              stroke="#ef4444"
